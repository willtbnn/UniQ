...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top py-3 box-shadow mb-5 pb-5">
        ...
        <div class="container">
            <div class="row">
                ...
                <address class="cols-sm-12 col-lg-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a class="btn btn-outline-warning btn-sm btn-block mb-2 bgf" style="max-width:140px;"  href="https://www.facebook.com/uniqrjsp">facebook</a></li>
                        <li><a class="btn btn-outline-warning btn-sm btn-block mb-2 bgf" style="max-width:140px;" href="">Twitter</a></li>
                        <li><a class="btn btn-outline-warning btn-sm btn-block mb-2 bgf" style="max-width:140px;"  href="https://www.instagram.com/grupo_uniq">Instragram</a></li>
                    </ul>
                </address>
            </div>
        </div>                
