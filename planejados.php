    ...
    <div class="row">
      <div class="col-xl-3 col-md-12">
          <div id="carouselplanejados" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <a class="carousel-control-next" href="#carouselplanejados" role="button" data-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="sr-only">Próximo</span>
            </a>
          </div>
      ...
      <div class="row">
          ...
          <div class="col-xl-3 col-md-12">
              <div id="carouselplanejados2" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/banheiros/IMG-20190217-WA0039.jpg" alt="Primeiro Slide">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/banheiros/476908084560535copia.jpg" alt="Segundo Slide">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/banheiros/0004334_banheiro-planejado-grande-copia.jpeg" alt="Terceiro Slide">
                  </div>
                </div>
                <a class="carousel-control-prev" href="#carouselplanejados2" role="button" data-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="sr-only">Anterior</span>
                </a>
                <a class="carousel-control-next" href="#carouselplanejados2" role="button" data-slide="next">
                  <span class="carousel-control-next-icon" aria-hidden="true"></span>
                  <span class="sr-only">Próximo</span>
                </a>
              </div>
  ...
  <div class="container ambientes py-5 bg-light js-left">
      ...
      <div class="col-xl-3 col-md-12">
          <div id="carouselplanejados3" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <a class="carousel-control-next" href="#carouselplanejados3" role="button" data-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="sr-only">Próximo</span>
            </a>
          </div>
...
<article class="container-fluid py-5 mt-5 bg-dark text-center text-light portifoliof" id="portifolio">
  ...
  <div class="embed-responsive embed-responsive-21by9">
    <iframe outoplay="false" class="embed-responsive-item" src="assets/videos/UniQinteriores.mp4" allowfullscreen>
    </iframe>
  </div>
  <!-- Melhor o iframe do bootstrap, aqui eu teria que cria todoo controles e responsividade ou adptar ao bootstrap já existente
  <section class="video">
          ...
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered portifolio1"  role="document">
                    <img src="assets/images/planejados/servico_1.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                  </div>
              </div>
          </div>
          <div class=" col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal2" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered portifolio2"  role="document">
                    <img src="assets/images/planejados/servico_2.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                  </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal3" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio3"  role="document">
                  <img src="assets/images/planejados/servico_3.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal4" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio4"  role="document">
                  <img src="assets/images/planejados/servico_4.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <figure class="figure" data-toggle="modal" data-target="portifoliomodal">
                <img src="assets/images/planejados/servico_5.jpg" class="figure-img img-fluid rounded" alt="Imagem de um quadrado genérico com bordas arredondadas, em uma figure.">
              </figure></button>
              <div class="modal fade " id="portifoliomodal11" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio5"  role="document">
                  <img src="assets/images/planejados/servico_5.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal6" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio6"  role="document">
                  <img src="assets/images/planejados/servico_6.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
      </div>
          ...
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal7" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio7"  role="document">
                  <img src="assets/images/planejados/servico_7.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal8" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio8"  role="document">
                  <img src="assets/images/planejados/servico_8.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal9" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio9"  role="document">
                  <img src="assets/images/planejados/servico_9.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal10" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio10"  role="document">
                  <img src="assets/images/planejados/servico_10.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal11" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio11"  role="document">
                  <img src="assets/images/planejados/servico_11.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal12" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio12"  role="document">
                  <img src="assets/images/planejados/servico_12.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
      </div>
          ...
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal13" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio13"  role="document">
                  <img src="assets/images/planejados/servico_13.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal14" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio14"  role="document">
                  <img src="assets/images/planejados/servico_14.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal15" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio15"  role="document">
                  <img src="assets/images/planejados/servico_15.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal16" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio16"  role="document">
                  <img src="assets/images/planejados/servico_16.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal17" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio17"  role="document">
                  <img src="assets/images/planejados/servico_17.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
          <div class="col-lg-2 col-sm-4">
              ...
              <div class="modal fade " id="portifoliomodal18" tabindex="-1" role="dialog" aria-labelledby="portifoliomodaltitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered portifolio18"  role="document">
                  <img src="assets/images/planejados/servico_18.jpg" alt="Mesa - preta" title="Imagem de mesa preta" class="figure-img img-fluid rounded">
                </div>
              </div>
          </div>
      </div>
