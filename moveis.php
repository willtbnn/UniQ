<section class="container-fluid mt-5 pt-5 mb-0 bg-moveis text-center">
    ...
    <h1 class="h5 escritamoveis mb-0">UniQ móveis tem padrão unico de trabalho, com madeiras da melhor qualidade. <br/>
        ...
        Entregamos em qualquer lugar no  Brasil.
    </h1>
</section>
...
<section class="container-fluid text-center pt-5 pb-5">
    <h5 class="h3 escritamoveis">Esses são alguns de nossos produtos pronta entregar.</h5>
</section>
<article class="container-fluid paleta2moveis text-center py-5">
    <p>Veja mais detalhes e nosso catálogo completo de produtos disponiveis</p>
    <a href="catalogo-de-produtos.pdf" target="_blank" class="btn btn-success">Catálogo completo</a>
</article>