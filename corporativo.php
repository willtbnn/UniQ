...
<section class=" container-fluid bg-light p-sm-5 row">
    ...
    <div class="col-lg-8 col-sm-12 align-self-center">
        <p class="">Se você está procurando uma empresa de marcenaria proﬁssional para ajudar em seu projeto, a Uniq é uma excelente opção. Somos especializados em marcenaria para escritórios, ambientes corporativos e comerciais. Produzimos móveis planejados e marcenaria de alto padrão. Envie-nos seu design e podemos trabalhar com você para garantir que seu trabalho esteja pronto para instalação. 
        </p>
    </div>
    <div class="col-lg-8 col-sm-12 pt-5 align-self-center">
        <p>
...
<article class="pt-5 pb-5 mt-0 container-fluid pg-empresa ">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-sm-12 align-self-center">
            <img src="assets/images/slogan/corporativo.png" class="img-fluid">
        </div>
    </div>
    <div class="text-center">
        <h6>
        <a href="pedidos" class="btn btn-outline-success bgf mt-5">Peça seu orçamento</a>
        </h6>
    </div>
</article>
<section class="container">
    <div class="row pt-4">
        <div class="col-md-4 col-sm-12 align-self-center">
            <span class="h6 text-coporativo">ATUAMOS EM PARCERIA COM:</span>
        </div>
